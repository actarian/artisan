import { Page } from '@artisan/core';

export const page: Page[] = [
	// { id: 1000, name: 'Homepage', title: 'Homepage', slug: '', component: 'HomeComponent' },
	// { id: 2000, name: 'Contact', title: 'Contact', slug: 'contact', component: 'ContactComponent' },
	{
		id: 1000,
		slug: '/',
	...
	},
	{
		id: 2000,
		slug: '/contacts',
		url: 'https://actarian.github.io/artisan/#/contacts',
		title: 'Contacts',
		abstract: 'Nam id suscipit tellus. Sed nec massa non mauris semper mattis in eget est.',
		...
		related: [{
			...
			page: {
				id: 75,
				slug: '/privacy',
				url: 'https://actarian.github.io/artisan/#/privacy',
				title: 'Privacy',
				component: 0,
				type: 0,
				active: false
